...
def main():
    stud1 = Student("Vanya", "Ivanov", math=5, literature=5)
    stud2 = Student("Dima", "Dimov", math=2, literature=4)
    stud3 = Student("Igor", "Igorev", math=5, literature=2)

    stud1.add_grade("economics", 4)
    stud1.change_grade("math", 2)

    group = Group(stud1, stud2)
